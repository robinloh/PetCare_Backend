...
let createTables = 
    ...
    'create view getPetsInfo as SELECT ownspet.email AS email, pets.name, petBreed.breedName, isofspecies.speciesname, hasdietrestrictions.diet, specialnotes.specialnote FROM ownspet LEFT JOIN pets on ownspet.pid = pets.pid LEFT JOIN petBreed ON ownspet.pid = petBreed.pid LEFT JOIN isofspecies on ownspet.pid = isofspecies.pid LEFT join hasdietrestrictions on ownspet.PID = hasdietrestrictions.pid left join specialnotes on ownspet.pid = specialnotes.pid;' +
